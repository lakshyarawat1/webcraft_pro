...
// ⚡ Bolt Optimization: Instantiate Intl.NumberFormat once outside of React render cycles
// or loops. Creating these objects is computationally expensive in JS engines.

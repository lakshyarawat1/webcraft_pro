...
export type PipelineDetailsWithLaneCardsTagsTickets = Prisma.PromiseReturnType<typeof getPipeLineDetails>
...
export const TicketFormSchema = z.object({
  ...
  value: z.number().refine((value) => currencyNumberRegex.test(value.toString()), {
